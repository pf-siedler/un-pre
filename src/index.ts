...
/*
GITHUB_TOKEN: GitHub の token。 最低限 repository の閲覧権限と release の書き込み権限が必要なはず
GITHUB_OWNER: herp-inc/hub の herp-inc の部分
GITHUB_REPO: herp-inc/hub の hub の部分
GITHUB_TAG: release に使用した tag
*/
const configD = pipe(
    RE.Do,
